...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí puedes especificar cuál de las conexiones de base de datos a continuación deseas
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | A continuación se muestran todas las conexiones de base de datos definidas para tu aplicación.
    | Se proporciona una configuración de ejemplo para cada sistema de base de datos que
    | es compatible con Laravel. Puedes agregar / eliminar conexiones libremente.
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Redis es un almacén de clave-valor de código abierto, rápido y avanzado que también
    | proporciona un cuerpo más rico de comandos que un sistema de clave-valor típico
